...
export default function StreamNetwork() {
  const links = [
    {
  ...
  return (
    <div>
      ...
      <p>
        ...
        rights (SRHR). We have linked with accredited trainers in the holistic,
        evidence-based Stepping Stones gender-transformative social norms change
        programmes to achieve our purpose. The STREAM Network was formed out of
        a 4-day meeting held in Nairobi, Kenya, in 2022, hosted by Positive
        Young Women Voices and funded by UNAIDS. STREAM stands for Stepping
        Stones Trainers Engaging with Activist Movements.
        <br />
        <br />
        The workshop brought together women living with HIV who are all feminist
        women’s rights activists, from Argentina, Cameroon, India, Kenya,
        Tanzania, Uganda, UK/Ireland and Zimbabwe; as well as long-term Stepping
        Stones female and male practitioners from Kenya, Tanzania, Uganda and
        Zimbabwe. The workshop comprised of participants with an age-range
        stretching from our mid- twenties to our late seventies. Together we
        resolved to join our diverse experiences, knowledge, skills and passions
        together to create the STREAM Network and a five-year global strategic
        plan was developed.
        <br />
        <br />
        The Network seeks a common purpose - to uphold and maintain the SRHR of
        women and girls especially in all our communities in the context of HIV,
        irrespective of our HIV status. We all recognize that violence against
        women, and against children form a key part of children’s and women’s
        vulnerability both to acquiring HIV and to living with HIV, across the
        life span.
      </p>
      <br />
      <br />
      ...
      <p>
        <strong>The STREAM Network Strategic Plan 2023 – 2027,</strong> created
        in our Nairobi workshop, highlights intergenerational solidarity and how
        it can be harnessed to end violence against adolescent girls and young
        women in the context of our SRHR. Within our communities, we all
        recognise also how the vicious cycle of VAW and VAC are both causes as
        well as consequences of HIV. These slow down, reduce - and often prevent
        - women's and children's realisation of their SRHR.
        <br />
        <Link
          href={"/stream-plan"}
          target="_blank"
      ...
      <p>
        ...
        together the 7 countries to localize the global strategic plan into each
        member’s country’s context. The localization process would see to it
        that the countries within the network move towards coming up with their
        own respective national priorities drawn from the bigger strategic plan.
        This was to make it easier for them to bring on board other stakeholders
        in a position to support the outcomes of the plan, as well as create
        avenues for them to efficiently resource mobilize towards program
        implementation. The network members aimed to hold a series of online and
        physical in-country meetings, to determine what the localization process
        would look like for each of them.
        <br />
        <br />
        ...
        sought to develop and share their advocacy briefs/ case studies with the
        key stakeholders/ partners they felt would be of assistance to them, as
        they strive to implement their in-country strategic plans.
      </p>
      ...
      <p className="mt-10">
        In early 2024, the STREAM Network expanded to welcome two new countries
        and networks, who are already familiar with using adapted versions of
        Stepping Stones:
      </p>
      ...
      <ol className="flex  flex-col gap-2">
        <li>
          1. "We hear the thunder but we see no rain: Lessons learnt in efforts
          to promote community-led evidence-based initiatives to advance our{" "}
          <Link
            className="text-blue-600 underline"
        ...
        <li>
          ...
          holistically across the genders, generations and HIV status to support
          girls, women, boys and men in communities to work together to uphold
          their SRHR{" "}
          <Link
            className="text-blue-600 underline"
        ...
        <li>
          ...
          website contains Stepping Stones Adaptation Guidelines and Frequently
          Asked Questions about how to adapt the Stepping Stones programmes in a
          way which ensures that it is best suited to each new context, while
          remaining aligned to the structure and principles of the original
          programme and up to date with the latest scientific information. You
          can contact Stepping Stones accredited trainers in your own country /
          region through this site.
        </li>
        ...
        <li>
          ...
          in and with communities. In our STREAM Strategic Plan, we have adapted
          the ALIVHE landscape theory of change, as well as the ALIVHE values
          and the gender change matrix.
        </li>
        ...
        <li>
          ...
          change programmes (including Stepping Stones), offers an alternative,
          ecological metaphor for scaling social norms change through women’s
          movements. Our STREAM Network strategy builds on this metaphor.
        </li>
      </ol>
    </div>
  );
